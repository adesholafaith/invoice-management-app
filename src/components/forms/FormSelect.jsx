  ...
  return (
    <div className="min-w-0">
      ...
      <select
        ...
        className={cn(
          'mt-1.5 block h-10 min-w-0 max-w-full w-full rounded-md border bg-white px-3.5 pr-9 text-sm text-[var(--text)] shadow-none outline-none transition duration-200 focus:ring-4',
          error
